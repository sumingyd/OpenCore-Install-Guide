...
* **ProtectMemoryRegions**: YES
  * 修复了在某些chromebook上关机/重启会导致`AppleEFINVRAM`内核崩溃的问题。
...
|**-igfxnotelemetryload** | 防止iGPU遥测数据加载。iGPU遥测可能会导致某些笔记本电脑启动时冻结，如macOS 10.15及更高版本的chromebook，请参阅[这里](https://github.com/acidanthera/WhateverGreen#intel-hd-graphics)了解更多信息。
